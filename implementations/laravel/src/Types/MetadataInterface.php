 ...
 * MetadataInterface
 *
 * Contract for entities that support metadata storage (framework-independent).
 *
 ...
 * - Implementations in Laravel: WaysNX\BusinessFramework\Contracts\MetadataInterface
